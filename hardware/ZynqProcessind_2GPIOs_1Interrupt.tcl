...
#
# ZynqProcessind_2GPIOs_1Interrupt.tcl: Tcl script for re-creating project 'FreeRTOS_Ej1_v3'
#
# Generated by Vivado on Wed Feb 28 18:10:51 CET 2018
...
#
# 1. This project restoration tcl script (ZynqProcessind_2GPIOs_1Interrupt.tcl) that was generated.
#
...
#
#    "/home/user/FreeRTOS_Ej1_v3/FreeRTOS_Ej1_v3.srcs/sources_1/bd/design_1/design_1.bd"
#    "/home/user/FreeRTOS_Ej1_v3/FreeRTOS_Ej1_v3.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
#*****************************************************************************************
...
set script_file "ZynqProcessind_2GPIOs_1Interrupt.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../FreeRTOS_Ej1_v3"]"

# Create project
create_project FreeRTOS_Ej1_v3 ./FreeRTOS_Ej1_v3 -part xc7z020clg484-1
...
set obj [get_projects FreeRTOS_Ej1_v3]
set_property "board_part" "em.avnet.com:zed:part0:1.3" $obj
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/FreeRTOS_Ej1_v3.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/FreeRTOS_Ej1_v3.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/FreeRTOS_Ej1_v3.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/FreeRTOS_Ej1_v3.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/FreeRTOS_Ej1_v3.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/FreeRTOS_Ej1_v3.cache/compile_simlib/vcs" $obj
...
set_property "ip_output_repo" "/home/user/FreeRTOS_Ej1_v3/FreeRTOS_Ej1_v3.cache/ip" $obj
...
set files [list \
 "[file normalize "$origin_dir/../../FreeRTOS_Ej1_v3/FreeRTOS_Ej1_v3.srcs/sources_1/bd/design_1/design_1.bd"]"\
 "[file normalize "$origin_dir/../../FreeRTOS_Ej1_v3/FreeRTOS_Ej1_v3.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../FreeRTOS_Ej1_v3/FreeRTOS_Ej1_v3.srcs/sources_1/bd/design_1/design_1.bd"
...
set file "$origin_dir/../../FreeRTOS_Ej1_v3/FreeRTOS_Ej1_v3.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
puts "INFO: Project created:FreeRTOS_Ej1_v3"
